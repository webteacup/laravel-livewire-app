                    ...
                    <table class="table table-flush" id="datatable-search">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-xs font-weight-normal">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('assets') }}/img/team-2.jpg" class="avatar avatar-xs me-2"
                                            alt="user image">
                            ...
                            <tr>
                                ...
                                <td class="text-xs font-weight-normal">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('assets') }}/img/team-1.jpg" class="avatar avatar-xs me-2"
                                            alt="user image">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button
                                            class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 me-2 btn-sm d-flex align-items-center justify-content-center"><i
                                                class="material-icons text-sm" aria-hidden="true">refresh</i></button>
                                        <span>Refunded</span>
                                    </div>
                                </td>
                                <td class="text-xs font-weight-normal">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button
                                            class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 me-2 btn-sm d-flex align-items-center justify-content-center"><i
                                                class="material-icons text-sm" aria-hidden="true">clear</i></button>
                                        <span>Canceled</span>
                                    </div>
                                </td>
                                <td class="text-xs font-weight-normal">
