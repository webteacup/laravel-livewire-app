                ...
                <div class="card-body p-3">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6 text-center mt-4 mt-lg-0">
                            <div class="border border-light border-1 border-radius-md py-3">
                                ...
                                <h4 class="font-weight-bolder mb-0"><span id="state4" countTo="4"></span><span
                                        class="small"> %</span></h4>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="input-group bg-gray-200 border-radius-md">
                                            ...
                                            <span class="input-group-text bg-transparent" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Referral code expires in 24 hours"><i
                                                    class="material-icons text-sm me-2">timer</i></span>
                                        </div>
                                    </div>
                                    <a href="javascript:;"
                                        class="btn btn-sm btn-outline-secondary ms-2 px-3 mb-0">Copy</a>
                                </div>
                                    ...
                                    <div class="card card-plain text-center">
                                        <div class="card-body">
                                            <div
                                                ...
                                                <i class="material-icons opacity-10" aria-hidden="true">add_link</i>
                                            </div>
                                            <p class="text-sm font-weight-normal mb-2">1. Create & validate your
                                                referral link and get </p>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="card card-plain text-center">
                                        <div class="card-body">
                                            <div
                                                class="icon icon-shape bg-gradient-dark shadow text-center border-radius-md mb-2">
                                                <i class="material-icons opacity-10" aria-hidden="true">savings</i>
                                            </div>
                                            <p class="text-sm font-weight-normal mb-2">2. For every order you
                                                make you get </p>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="card card-plain text-center">
                                        <div class="card-body">
                                            ...
                                            <p class="text-sm font-weight-normal mb-2">3. Get other friends to
                                                generate link and get </p>
                    ...
                    <div class="row mt-4">
                            ...
                            <div class="card text-center">
                                <div class="overflow-hidden position-relative border-radius-lg bg-cover p-3"
                                    ...
                                    <div class="card-body position-relative z-index-1 d-flex flex-column mt-5">
                                        <p class="text-white font-weight-bolder">User #hashtag in a photo on
                                            social media and get $10 for each purchase you make.</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mt-4 mt-md-0">
                            <div class="card text-center">
                                <div class="overflow-hidden position-relative border-radius-lg bg-cover p-3"
                                    style="background-image: url('{{ asset('assets') }}/img/office-dark.jpg')">
                                    <span class="mask bg-gradient-dark opacity-6"></span>
                                    <div class="card-body position-relative z-index-1 d-flex flex-column mt-5">
                                        <p class="text-white font-weight-bolder">Send the invitation link to 10
                                            friends and get a 50% coupon to use on any purchase.</p>
                                        <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-4"
                                            href="javascript:;">
                                            Read More
                                            <i class="material-icons text-sm ms-1 position-relative"
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0">
                            <div class="card text-center">
                                <div class="overflow-hidden position-relative border-radius-lg bg-cover p-3"
                                    style="background-image: url('{{ asset('assets') }}/img/home-decor-1.jpg')">
                                    <span class="mask bg-gradient-dark opacity-6"></span>
                                    <div class="card-body position-relative z-index-1 d-flex flex-column mt-5">
                                        <p class="text-white font-weight-bolder">Refer one friend and you will
                                            get $100 on each product he purchases.</p>
                                        <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-4"
                                            href="javascript:;">
                                            Read More
                                            <i class="material-icons text-sm ms-1 position-relative"
                            ...
                            <tbody>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            ...
                                            <i class="material-icons ms-1 mt-1 text-success opacity-10"
                                                ...
                                                title=""
                                                data-bs-original-title="Refund rate is lower with 97% than other users">expand_less</i>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            <div>
                                                <img src="{{ asset('assets') }}/img/team-2.jpg" class="avatar me-3"
                                                    alt="avatar image">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">John Alura</h6>
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                        class="text-success font-weight-bold">12.821</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            <div>
                                                <img src="{{ asset('assets') }}/img/team-3.jpg" class="avatar me-3"
                                                    alt="avatar image">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">Andrew Sian</h6>
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                        class="text-success font-weight-bold">2.421</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            ...
                                            <i class="material-icons ms-1 mt-1 text-danger opacity-10"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            <div>
                                                <img src="{{ asset('assets') }}/img/team-4.jpg" class="avatar me-3"
                                                    alt="avatar image">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">Luca Willaim</h6>
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                        class="text-success font-weight-bold">5.921</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            <p class="text-sm font-weight-normal mb-0">05</p>
                                            <i class="material-icons ms-1 mt-1 text-success opacity-10"
                                                aria-hidden="true">expand_less</i>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            <div>
                                                <img src="{{ asset('assets') }}/img/team-5.jpg" class="avatar me-3"
                                                    alt="avatar image">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">Richel Manuel</h6>
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                        class="text-success font-weight-bold">921</span> orders
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            <p class="text-sm font-weight-normal mb-0">99</p>
                                            <i class="material-icons ms-1 mt-1 text-danger opacity-10"
                                                aria-hidden="true" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                title=""
                                                data-bs-original-title="Refund rate is higher with 70% than other users">expand_more</i>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
