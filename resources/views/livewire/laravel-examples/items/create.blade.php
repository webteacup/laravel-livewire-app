                        ...
                        <div class="card-body">
                            <form wire:submit="store" class='d-flex flex-column align-items-center'
                                ...
                                <div class="form-group col-12 col-md-6 mt-3">
                                    ...
                                    <select wire:model.blur="category_id" class="form-select border border-2 p-2"
                                ...
                                <div class="form-group col-12 col-md-6 mt-3">
                                    ...
                                    <div class="form-check">
                                        <input wire:model.live="status" class="form-check-input" type="radio"
                                    ...
                                    <div class="form-check">
                                        <input wire:model.live="status" class="form-check-input" type="radio" id="draft"
                                            value='draft'>
                                    ...
                                    <div class="form-check">
                                        <input wire:model.live="status" class="form-check-input" type="radio" id="archive"
                                            value='archive'>
                                ...
                                <div class="form-check form-switch col-12 col-md-6 mt-3">
                                    <label class="form-check-label" for="flexSwitchCheckDefault">Show on
                                        homepage</label>
                                    <input wire:model.live="showOnHomepage" class="form-check-input" type="checkbox"
                                ...
                                <div class="form-group col-12 col-md-6 mt-3">
                                    ...
                                    <div class="form-check">
                                        <input wire:model.live="options" class="form-check-input" type="checkbox"
